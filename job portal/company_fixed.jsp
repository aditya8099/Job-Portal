...
if("POST".equalsIgnoreCase(request.getMethod())) {
  ...
  if(editIdParam != null && !editIdParam.trim().equals("0") && editIdParam.trim().length() > 0) {
    try {
...
<div class="container mt-4">
  <h2 class="mb-5 text-center fw-bold text-success">Welcome, <%=companyName%>! (Debug: <%=companyName%>)</h2>
  <% if(message.length() > 0) { %>
  ...
  <div class="row g-4 mb-5">
        ...
        <div class="card-body p-4">
          <form method="post">
            ...
            <div class="d-flex gap-2">
              ...
              <% if(isEdit) { %>
              <a href="company.jsp" class="btn btn-secondary px-4 py-2">Cancel</a>
              <% } %>
            </div>
          </form>
        </div>
    ...
    <div class="col-lg-4">
      <div class="card shadow-lg h-100">
        ...
        <div class="card-body">
          <a href="company.jsp" class="btn btn-primary w-100 mb-2 <%= !isEdit ? "active" : "" %>">Post New</a>
          <a href="jobs.jsp" class="btn btn-outline-success w-100 mb-2">All Jobs</a>
          <a href="#applications" class="btn btn-outline-info w-100 mb-2">Applications</a>
  ...
  <div class="row g-4 mb-5">
    <div class="col-12">
      <h4 class="mb-4"><i class="fas fa-briefcase me-2 text-success"></i>My Jobs (<%=companyName%>)</h4>
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody>
            ...
            %>
            <tr>
              <td><strong><%=rsJobs.getString("title")%></strong></td>
              <td><span class="badge bg-success"><%=rsJobs.getString("salary")%></span></td>
              <td><%=rsJobs.getString("experience")%></td>
              <td><%= new java.text.SimpleDateFormat("MMM dd").format(rsJobs.getTimestamp("created_at")) %></td>
              <td>
  ...
  <div id="applications" class="row g-4">
    <div class="col-12">
      <h4 class="mb-4"><i class="fas fa-users me-2 text-primary"></i>Applications</h4>
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="profile.jsp?view=<%=rsApps.getString("applicant")%>"><%=rsApps.getString("applicant")%></a></td>
              <td><span class="badge bg-<%= "accepted".equals(rsApps.getString("status")) ? "success" : "rejected".equals(rsApps.getString("status")) ? "danger" : "secondary" %>"><%=rsApps.getString("status")%></span></td>
              <td>
                <form method="get" action="update_status.jsp" style="display:inline">
            ...
            <tr>
              <td colspan="4" class="text-center text-muted py-4">
                <i class="fas fa-paper-plane fa-3x mb-3 opacity-50"></i><br>
                No applications yet.
              </td>
            </tr>
            <% } %>
